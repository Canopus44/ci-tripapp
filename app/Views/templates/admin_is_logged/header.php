        ...
        <div class="container-fluid">
                ...
                <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
                    <div class="position-sticky pt-3">
                        <ul class="nav flex-column">
                            <li class="nav-item">
                                <a class="nav-link active" aria-current="page" href="<?= base_url(route_to('dashboard')) ?>">
            ...
            <a class="nav-link" href="#">
              ...
              Products
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="<?= base_url(route_to('clientes')) ?>">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="<?= base_url(route_to('lista_sitios')) ?>">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="<?= base_url(route_to('agregar_sitio')) ?>">
